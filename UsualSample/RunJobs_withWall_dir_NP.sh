								...
								do
									...
									do
										...
										do
											...
											fileNamePrefix=${meshFineness}NPDirWithWallDRS1.5_${drs}ModA_${A}_AmB${AmB}_Load${Load}_Vw${Vw}_fw${fw}_theta${theta1}_${theta1}_NULoad2dir${NULoad}_duration${duration}
											python3 createInputs_withWall_Dirichlet_NP.py modifyFiles --DRS=$drs --Load=$load --Vw=$Vw --fw=$fw --theta1=$theta1 --theta2=$theta1 --A=$A --AmB=$AmB --NULoad=$NULoad --meshFineness=$meshFineness --duration=$duration
