...
class FileModifier(object):
    ...
    def modifyFiles(self, DRS, Load, Vw, fw, theta1, theta2, A, AmB, Lw, NULoad, meshFineness, duration, rest, NPOP):
        ...
        if NPOP == 0:
            fileNamePrefix = str(meshFineness) + "VaryingBOPDirWithWallDRS1.5_" + str(DRS) + "ModA" + str(A) + "AmB" + str(AmB) + "Lw" + str(Lw) + "Load" + str(Load) + "_Vw" + str(Vw) + "_fw" + str(fw) + "_theta" + str(theta1) + "_" + str(theta2) + "_NULoad2dir" + str(NULoad) + "_duration" + str(duration) + "_" + str(rest)
        elif NPOP == 1:
            fileNamePrefix = str(meshFineness) + "VaryingBNPDirWithWallDRS1.5_" + str(DRS) + "ModA" + str(A) + "AmB" + str(AmB) + "Lw" + str(Lw) + "Load" + str(Load) + "_Vw" + str(Vw) + "_fw" + str(fw) + "_theta" + str(theta1) + "_" + str(theta2) + "_NULoad2dir" + str(NULoad) + "_duration" + str(duration) + "_" + str(rest)
        
        mainCFGr = open("UsualSampleVSFH_withWall_Dirichlet_varyingBSW.cfg", 'r')
        ...
        if NPOP == 0:
            list_of_lines[197] = "friction.db_properties.iohandler.filename = spatialdb/rateStateProps_withWall_varyingBSW.spatialdb\n"
        elif NPOP == 1:
            list_of_lines[197] = "friction.db_properties.iohandler.filename = spatialdb/rateStateProps_withWall_NP_varyingBSW.spatialdb\n"
        ...
        mainCFGw = open("UsualSampleVSFH_withWall_Dirichlet_varyingBSW.cfg", 'w')
        ...
        ## Modify rateStateProps
        if NPOP == 0:
            fricDBr = open("spatialdb/rateStateProps_withWall_varyingBSW.spatialdb", 'r')
        elif NPOP == 1:
            fricDBr = open("spatialdb/rateStateProps_withWall_NP_varyingBSW.spatialdb", 'r')
        ...
        list_of_lines[81] = " 0.015974  0.008855 -0.002800     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(Lw) * 1e-6) + "\n"
        ...
        list_of_lines[82] = " 0.015974  0.008855  0.003200     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(Lw) * 1e-6) + "\n"
        ...
        list_of_lines[105] = " 0.022972  0.012733 -0.002800     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(Lw) * 1e-6) + "\n"
        ...
        list_of_lines[106] = " 0.022972  0.012733  0.003200     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(Lw) * 1e-6) + "\n"
        ...
        ## Modify rateStateProps
        if NPOP == 0:
            fricDBw = open("spatialdb/rateStateProps_withWall_varyingBSW.spatialdb", 'w')
        elif NPOP == 1:
            fricDBw = open("spatialdb/rateStateProps_withWall_NP_varyingBSW.spatialdb", 'w')
