...
class FileModifier(object):
    ...
    def modifyFiles(self, DRS, Load, Vw, fw, theta1, theta2, A, AmB, NULoad, meshFineness, duration):
        ...
        ## Main CFG file
        fileNamePrefix = str(meshFineness) + "DirWithWallDRS1.5_" + str(DRS) + "ModA" + str(A) + "AmB" + str(AmB) + "Load" + str(Load) + "_Vw" + str(Vw) + "_fw" + str(fw) + "_theta" + str(theta1) + "_" + str(theta2) + "_NULoad2dir" + str(NULoad) + "_duration" + str(duration)
