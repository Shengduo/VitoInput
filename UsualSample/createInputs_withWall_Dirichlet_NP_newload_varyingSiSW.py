...
class FileModifier(object):
    ...
    def modifyFiles(self, DRS, Load, Vw, fw, theta1, theta2, A, AmB, LLow, LHigh, fwLexp, SiLow, SiHigh, NULoad, meshFineness, duration, rest, NPOP):
        ...
        if NPOP == 0:
            fileNamePrefix = str(meshFineness) + "VaryExpSiOPDirWithWallDRS1.5_" + str(DRS) + "ModA" + str(A) + "AmB" + str(AmB) + "L" + str(LLow) + "_" + str(LHigh) + "_" + str(fwLexp) + "Si" + str(SiLow) + "_" + str(SiHigh) + "Load" + str(Load) + "_Vw" + str(Vw) + "_fw" + str(fw) + "_theta" + str(theta1) + "_" + str(theta2) + "_NULoad2dir" + str(NULoad) + "_duration" + str(duration) + "_" + str(rest)
        elif NPOP == 1:
            fileNamePrefix = str(meshFineness) + "VaryExpSiNPDirWithWallDRS1.5_" + str(DRS) + "ModA" + str(A) + "AmB" + str(AmB) + "L" + str(LLow) + "_" + str(LHigh) + "_" + str(fwLexp)  + "Si" + str(SiLow) + "_" + str(SiHigh) + "Load" + str(Load) + "_Vw" + str(Vw) + "_fw" + str(fw) + "_theta" + str(theta1) + "_" + str(theta2) + "_NULoad2dir" + str(NULoad) + "_duration" + str(duration) + "_" + str(rest)
        
        mainCFGr = open("UsualSampleVSFH_withWall_Dirichlet_varyingSiSW.cfg", 'r')
        ...
        if NPOP == 0:
            list_of_lines[197] = "friction.db_properties.iohandler.filename = spatialdb/rateStateProps_withWall_varyingSiSW.spatialdb\n"
        elif NPOP == 1:
            list_of_lines[197] = "friction.db_properties.iohandler.filename = spatialdb/rateStateProps_withWall_NP_varyingSiSW.spatialdb\n"
        ...
        mainCFGw = open("UsualSampleVSFH_withWall_Dirichlet_varyingSiSW.cfg", 'w')
        ...
        ## Modify rateStateProps
        if NPOP == 0:
            fricDBr = open("spatialdb/rateStateProps_withWall_varyingSiSW.spatialdb", 'r')
        elif NPOP == 1:
            fricDBr = open("spatialdb/rateStateProps_withWall_NP_varyingSiSW.spatialdb", 'r')
        list_of_lines = fricDBr.readlines()
           
        list_of_lines[55] = " 0.006354  0.003522 -0.003900     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(LLow) * 1e-6) + "  " + str(float(LHigh) * 1e-6) + "  " + str(float(SiLow) * 1e6) + "  " + str(float(SiHigh) * 1e6) +  "  " + str(float(fwLexp) * 1e-6) + "\n"
        list_of_lines[56] = " 0.006354  0.003522  0.004300     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(LLow) * 1e-6) + "  " + str(float(LHigh) * 1e-6) + "  " + str(float(SiLow) * 1e6) + "  " + str(float(SiHigh) * 1e6) +  "  " + str(float(fwLexp) * 1e-6) + "\n"
 
        list_of_lines[64] = " 0.063204  0.035034 -0.003900     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(LLow) * 1e-6) + "  " + str(float(LHigh) * 1e-6) + "  " + str(float(SiLow) * 1e6) + "  " + str(float(SiHigh) * 1e6) +  "  " + str(float(fwLexp) * 1e-6) + "\n"
        list_of_lines[65] = " 0.063204  0.035034  0.004300     0.58  1e-6   " + str(float(DRS) * 1e-6) + "  " + str(A) + "  " + str(B) + "  0.0  " + str(fw) + "  " + str(Vw) + "  " + str(float(LLow) * 1e-6) + "  " + str(float(LHigh) * 1e-6) + "  " + str(float(SiLow) * 1e6) + "  " + str(float(SiHigh) * 1e6) +  "  " + str(float(fwLexp) * 1e-6) + "\n"
        ...
        ## Modify rateStateProps
        if NPOP == 0:
            fricDBw = open("spatialdb/rateStateProps_withWall_varyingSiSW.spatialdb", 'w')
        elif NPOP == 1:
            fricDBw = open("spatialdb/rateStateProps_withWall_NP_varyingSiSW.spatialdb", 'w')
    ...
    def modifyFiles_GougeDifferentLoad(self, DRS, Load, Vw, fw, theta1, theta2, A, NULoad):
        ...
        list_of_lines[51] = " 0.006354  0.003522  0.004300     0.58  1e-6   " + str(float(DRS) * 1e-6)+ "  " + str(A) + "  0.003  0.0  " + str(fw) + "  " + str(Vw) + "\n"
        list_of_lines[59] = " 0.063204  0.035034 -0.003800     0.58  1e-6   " + str(float(DRS) * 1e-6)+ "  " + str(A) + "  0.003  0.0  " + str(fw) + "  " + str(Vw) + "\n"
        list_of_lines[60] = " 0.063204  0.035034  0.004300     0.58  1e-6   " + str(float(DRS) * 1e-6)+ "  " + str(A) + "  0.003  0.0  " + str(fw) + "  " + str(Vw) + "\n"
